        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-full h-[500px] rounded-3xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 shadow-2xl border border-gray-700">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="text-gray-300 mb-4">Discord Server</p>
